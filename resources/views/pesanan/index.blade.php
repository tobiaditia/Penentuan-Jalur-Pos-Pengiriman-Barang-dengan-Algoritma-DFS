...
@section('content')
    ...
    <table id="tablePesananBelumKirim" class="table table-striped table-bordered table-sm w-100">
        <thead>
            <tr>
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('#tablePesananBelumKirim').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('pesanan.belum-dikirim') }}",
                    type: "GET"
                },
                columns: [{
                        data: 'DT_RowIndex',
